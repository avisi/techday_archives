 ...
 * two {@link nl.avisi.techday.nosql.mongo.Album}s and populate them with {@link nl.avisi.techday.nosql.mongo.Track}s.
 * 
...
public abstract class AbstractIntegrationTest {
	...
	public void setUp() {
		...
		thePursuit.add(new Track(5, "Don't stop the nl.avisi.techday.nosql.mongo"));
